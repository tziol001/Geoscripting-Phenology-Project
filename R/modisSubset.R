...
modisSubset <-
  function(site, band, year, rel = TRUE)
  {
    ...
    # download the modis subset data for the selected fluxtower. If the file exists   already in the working directory the function just read the table without download it again.
